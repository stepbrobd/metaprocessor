...
import Nix from "public/nix.svg";
    ...
    <div className="w-full flex flex-col items-center md:items-start space-y-8">
      <div>
        <a
          ...
          href="https://builtwithnix.org"
        >
          <Image src={Nix} alt="Build with Nix" />
        </a>
      </div>
      ...
      <div>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          href="https://nextra.site?utm_source=stepbrobd&utm_campaign=oss"
        >
      ...
      <div>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          href="https://vercel.com?utm_source=stepbrobd&utm_campaign=oss"
        >
      ...
      <hr className="w-full dark:border-neutral-800" />
